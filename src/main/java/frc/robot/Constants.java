...
public final class Constants {
  ...
  public static final class SwerveConstants{
    ...
    public static final double maxModuleSpeed = 4.11;
    ...
    public static final Translation2d flModuleOffset = new Translation2d(WHEEL_BASE / 2, TRACK_WIDTH / 2);
    public static final Translation2d frModuleOffset = new Translation2d(WHEEL_BASE / 2, -TRACK_WIDTH / 2);
    public static final Translation2d blModuleOffset = new Translation2d(-WHEEL_BASE / 2, TRACK_WIDTH / 2);
    public static final Translation2d brModuleOffset = new Translation2d(-WHEEL_BASE / 2, -TRACK_WIDTH / 2);
